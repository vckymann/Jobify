...
function Page() {  
  ...
  return (
    <>
    {processingMessage !== "" && <div className='fixed top-0 left-0 w-full h-full bg-neutral-800 bg-opacity-95 flex items-center justify-center z-50'><div className='text-white text-2xl'>{processingMessage}</div></div>}
    <div className='flex flex-col mx-auto max-w-lg dark:text-white'>
      ...
      {resumePath ? (
        ...
        <DropdownMenuDemo setProcessingMessage={setProcessingMessage} setResumePath={setResumePath} resumePath={resumePath} />
        </>
      ): (
